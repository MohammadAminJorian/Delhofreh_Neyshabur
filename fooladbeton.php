...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>شرکت طراحی و توسعه</title>
    <style>
        /* تنظیمات کلی */
        body {
            font-family: 'Arial', sans-serif;
...
<body>
    ...
    <div class="container-shh">
        ...
        <div class="company-header-shh">
            <h1>شرکت فولاد بتن</h1>
            <img src="static/image/fooladbeton/1.jpg" alt="Logo" class="company-logo-shh">
        </div>
        <p class="company-header-shh"></p>
...
شرکت فولاد بتن فیروزه با هدف تأمین نیازهای منطقه در حوزه مصالح ساختمانی تأسیس شده و به عنوان یکی از پیشگامان صنعت راه‌سازی و ساختمان‌سازی، فعالیت خود را در فضایی به وسعت ۱۲,۰۰۰ متر مربع آغاز کرده است. این مجموعه با بهره‌گیری از جدیدترین تکنولوژی‌ها و پیشرفته‌ترین تجهیزات روز دنیا، توانسته است تولیدات متنوعی را با بالاترین استانداردهای کیفی ارائه دهد.
...
<br>
  محصولات بتنی غیر مسطح (از بتن معمولی) – ظرفیت ۶۶,۰۰۰ تن در سال ✅ 
<br>
 محصولات بتنی مسلح پیش‌ساخته – ظرفیت ۷۰,۰۰۰ تن در سال ✅
<br>
 محصولات بتنی مسلح پیش‌تنیده – ظرفیت ۶۰,۰۰۰ تن در سال ✅
<br>
 محصولات بتنی غیر مسلح (از بتن سبک و پوکه صنعتی) – ظرفیت ۴۴,۰۰۰ تن در سال ✅
<br>
<br>
تعهد ما در فولاد بتن فیروزه، ارائه محصولات باکیفیت، مقاوم و مقرون‌به‌صرفه برای پروژه‌های عمرانی و ساختمانی است. هدف ما، ایجاد زیرساخت‌هایی پایدار و مطمئن برای آینده‌ای بهتر است.

چرا ما؟
✔ استفاده از فناوری‌های روز دنیا
✔ تولید با استانداردهای جهانی
✔ ظرفیت تولیدی بالا و متنوع
✔ تعهد به کیفیت و رضایت مشتری
<br><br>
!برای اطلاعات بیشتر و دریافت مشاوره، با ما در ارتباط باشید     
           <br><br>
            </p>
        </div>
        ...
        <div class="image-gallery-shh">
            <img src="static/image/fooladbeton/2.jpg" alt="Image 1">
            <img src="static/image/fooladbeton/5.jpg" alt="Image 2">
            <img src="static/image/fooladbeton/8.jpg" alt="Image 3">
            <img src="static/image/fooladbeton/10.jpg" alt="Image 4">
        </div>

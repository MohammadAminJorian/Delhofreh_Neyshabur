...
<head>
    ...
    <style>
        ...
        .container {
            ...
            background: url('static/image/home/111.jpg') no-repeat center center fixed;
...
<body>
    <div class="container">
        <div class="content">
            <div class="manager-photo">
                <img src="static/image/home/1.jpg" alt="مدیر">
            </div>
    ...
    <script>
        const fullText = `
            موسس و بنیان گذار– حاج محمد تقی پور مدیر عامل<br>
            حفظ کیفیت محصولات، ارائه خدمات مطلوب، صیانت از محیط زیست و تکریم مشتریان نشانه‌ی تعهد واحدهای تولیدی این مجموعه به مصرف‌کنندگان و مشتریان است. با تلاش فراوان در طی سالیان متمادی پایه‌های حرکت خود را بنا نهاده و با برنامه‌ریزی و بروز نمودن تجهیزات و ماشین‌آلات و همچنین احترام به درخواست‌های کارفرمایان و مشتریان وفادار خود توانسته‌ایم جایگاه خود را تثبیت نماییم و امروز در بین عموم از نامی شایسته برخوردار باشیم.<br><br>

            البته در اختیار داشتن گواهینامه‌های مختلف و متعدد نظام کیفی، مؤکد پایبندی به اصول و موازین کیفیت است و در این راه تدوین و اجرای کلیه دستورالعمل‌ها و رویه‌های مربوط به تضمین کیفیت و برنامه‌های عملیات مهندسی و کنترل مستمر کیفیت محصولات در هنگام تولید و زمان تحویل پروژه‌ها به منظور حداکثرسازی کارایی و اثربخشی عملیات انجام شده توسط عوامل تولید (نیروی انسانی دلسوز و تجهیزات پیشرفته) به طور جدی و تنگاتنگ در واحدهای تولیدی و اجرائی جاری می‌باشد.<br><br>

            درضمن برقراری سیستم‌های یکپارچه و پایدار مدیریت پروژه که طی آن کلیه استانداردها از بعد تولید، زمان‌بندی و عمر مفید محصولات رعایت و به اجرا درآمده است، تا همواره از بزرگ‌ترین سرمایه که همان خشنودی و رضایت کارفرمایان و مشتریان است بی‌بهره نماند.
        `;

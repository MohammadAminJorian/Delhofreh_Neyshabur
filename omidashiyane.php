...
<head>
    ...
    <style>
        ...
        .company-header-shh {
            ...
            display: flex;
            align-items: center;
            justify-content: flex-end; /* عنوان به سمت راست منتقل شد */
        }
...
<body>
    ...
    <div class="container-shh">
        ...
        <div class="company-header-shh">
            <h1>شرکت مهندسی امید آشیانه</h1>
            <img src="static/image/omid/1.jpg" alt="Logo" class="company-logo-shh">
        </div>
        <p class="company-header-shh">            شرکت مهندسی امید آشیانه – پیشگام در راه‌سازی و ساختمان‌سازی
        </p>
...
پیشرفت فناوری، ارتقای تجهیزات، ادغام داده‌ها و استفاده از واقعیت مجازی، فرصت‌های بی‌نظیری را در دنیای مهندسی، تأمین و صنعت ساخت‌وساز ایجاد کرده است. امروز، اجرای پروژه‌ها به شکلی ایمن‌تر، سریع‌تر، هماهنگ‌تر و باکیفیت‌تر انجام می‌شود. شرکت مهندسی امید آشیانه با بهره‌گیری از این تحولات و تکیه بر تخصص، تعهد و توانمندی‌های داخلی، توانسته است نقش مهمی در توسعه پایدار، نوآوری و بومی‌سازی صنعت ساخت‌وساز ایفا کند.
<br>    <br>
چشم‌انداز و مأموریت ما
<br><br>
شرکت امید آشیانه، با گرید رسمی راه‌سازی و ساختمان‌سازی، از سال ۱۳۷۵ در این صنعت حضور فعال داشته و با اجرای پروژه‌های کلان عمرانی، سهم بسزایی در بهبود زیرساخت‌های کشور داشته است. ما به کیفیت، انطباق با استانداردها، توسعه پایدار و بهره‌وری بالا متعهد هستیم و همواره تلاش می‌کنیم تا پروژه‌های خود را با بالاترین استانداردهای مهندسی به انجام برسانیم.
<br><br>
پروژه‌های شاخص اجرا شده و در حال اجرا
<br>
:
راه‌سازی و بهسازی جاده‌ها ✅ 

<br>
<br>
احداث مسیر ضلع شمال بلوار امام رضا (ع) در شهر فیروزه (۱۳۹۶)
<br>
روکش آسفالت محور فیروزه - عبدالله گیو (۲۵ کیلومتر) – ۱۳۹۵
<br>
:اجرای آسفالت مسیرهای شهری و روستایی شامل
<br>
... شهرداری‌های فیروزه، درود، خرو، بار، عشق‌آباد، همت‌آباد، نیشابور و 
<br>
... روکش راه‌های روستایی به طول حدود ۳۰ کیلومتر در مناطق بوژان، باغشن، فیلخانه، سومعه، دربهشت، بشرآباد، محور باغرود و 
<br>
<br>
...
پروژه‌های متعدد در مسیرهای: نیرآباد - توزندجان، امیرآباد، دربهشت - بوژان، دزق، بزق، چهارباغ - طاقان، ارقش، کاریز صباح، عبیرآباد، فدیشه – ده حسینی، ریزآب – چاه سالار، امان‌آباد - دولت‌آباد، محمودآباد فضل – کاریزک، ده حلاج، وزیریه، حصار نو، قدمگاه – اسحاق‌آباد، فوشنجان، باغشن – گرینه، رحمت‌آباد – گلشن، قدمگاه – شهرک صنعتی، بهشت فضل – یوسف‌آباد، علی‌آباد کوری، بوژمهران، سعدآباد، آنتنی ادگ و

<br>
اجرای آسفالت معابر بیش از ۱۰۰ روستا در حوزه بنیاد مسکن خراسان رضوی

<br>
 بهره‌گیری از جدیدترین فناوری‌های روز در راه‌سازی و ساختمان‌سازی ✔
<br>
 اجرای پروژه‌ها با استانداردهای مهندسی و اصول توسعه پایدار ✔
<br>
 سابقه درخشان در پروژه‌های ملی و استانی ✔
<br>
 تیمی متعهد، متخصص و مجرب ✔
<br><br>
.این شرکت را در زمره برترین شرکت های راهسازی و ساختمانی نموده است
<br>
        ...
        <div class="image-gallery-shh">
            <img src="static/image/omid/2.jpg" alt="Image 1">
            <img src="static/image/omid/3.jpg" alt="Image 2">
            <img src="static/image/omid/4.jpg" alt="Image 3">
            <img src="static/image/omid/5.jpg" alt="Image 4">
        </div>
